...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
            .sendForm('service_qnxmvl6', 'template_tphepg8', formRef.current, {
                publicKey: 'zQw9DFmIZ4dZnpOiT',
            })
            .then(
                () => {
                    setSucces(true);
        ...
        <motion.div className="contact" variants={variants} initial="initial" whileInView="animate" ref={ref}>
            <motion.div className="textContainer">
                ...
                <motion.div className="item" variants={variants}>
                    ...
                    <span>
                        Kappacherri House Nadapuram Kerala
                    </span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>
